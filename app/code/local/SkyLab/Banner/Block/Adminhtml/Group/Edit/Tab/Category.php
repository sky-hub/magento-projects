...
/**
 * Class SkyLab_Banner_Block_Adminhtml_Group_Edit_Tab_Category
 */
class SkyLab_Banner_Block_Adminhtml_Group_Edit_Tab_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('skylab/banner/group/categories.phtml');
    ...
    {
        $categories = array();
        foreach ($this->_getCurrentGroup()->getSelectedCategories() as $category) {
            $categories[$category->getCategoryId()] = array('position' => $category->getPosition());
        }
    ...
    /**
     * Return array with category IDs which the group is assigned to
     *
     * @return array
     */
    protected function getCategoryIds()
    {
        return $this->_getSelectedCategories();
    }
