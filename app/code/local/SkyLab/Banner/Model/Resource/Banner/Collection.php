...
/**
 * Class SkyLab_Banner_Model_Resource_Banner_Collection
 */
class SkyLab_Banner_Model_Resource_Banner_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->joinLeft(
                array('group_banner' => $this->getTable('skylab_banner/group_banner')),
                'group_banner.banner_id = main_table.id',
                array('position')
            );
            $this->getSelect()->joinLeft(
                array('group' => $this->getTable('skylab_banner/group')),
                'group.id = group_banner.group_id',
                null
            );
